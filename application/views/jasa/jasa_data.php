...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Jasa <i class='fa fa-angle-right fa-fw'></i> Semua Jasa</h5>
			<hr />
			<a style="margin-bottom: 8px;" href="<?php echo site_url('jasa/tambah_jasa');?>" class='btn btn-success' id='Tambahjasa'> Tambah Jasa</a>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('jasa/jasa_json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
	...
	$(document).on('click', '#Tambahjasa', function(e){
		e.preventDefault();

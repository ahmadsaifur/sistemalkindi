...
<div class="container-fluid">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5 style="color:red"><i class='fa fa-shopping-cart fa-fw'></i> Penjualan <i class='fa fa-angle-right fa-fw'></i> History Penjualan Klinik</h5>
			<hr />

			<a href="<?php echo site_url('penjualan/history');?>" type="button" class="btn btn-success">Transaksi OK</a>
			<a href="<?php echo site_url('penjualan/history_acc_apotek'); ?>" type="button" class="btn btn-primary">Transaksi Pending</a>
			
			<?php if($level == 'admin') { ?>
			<a href="<?php echo site_url('penjualan/history_hapus_klinik'); ?>" type="button" class="btn btn-danger">Transaksi Hapus</a>
			<?php } ?>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"iDisplayLength": 15,
			"aLengthMenu": [[15, 30, 50, 100, 150], [15, 30, 50, 100, 150]],
			"ajax":{
				url :"<?php echo site_url('penjualan/history_json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

			...
			<div class='row'>
						...
						<div class="panel-body">
							...
							<div class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div id='telp_pelanggan'><small><i><?php echo $master->telp_pelanggan ;?></i></small></div>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-4 control-label">Alamat</label>
									<div class="col-sm-8">
										<div id='alamat_pelanggan'><small><i><?php echo $master->alamat_pelanggan ;?></i></small></div>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input id="id_herbalis" readonly="readonly" class="form-control" type="text" name="nama_herbalis" value="<?php echo $master->nama_sales ;?>">
								...
								<div class="form-group">
									<label class="col-sm-4 control-label">Kota ATY</label>
									<div class="col-sm-8"> 
										<!--<input id="aty" readonly="readonly" class="form-control" type="text" name="kota_aty" value="<?php echo $master->ATY_kota ;?>"> -->
								...
								<div class="form-group">
									<label class="col-sm-4 control-label">Nama Herbalis</label>
									<div class="col-sm-8"><!-- 
				...
				<div class='col-sm-9'>
						...
						foreach($detail->result() as $d)
						{
							echo "
								<tr>
									...
									<td><input type='text' step='any' class='form-control' id='discount' name='discount[]' value='".$d->discnya."'></td>
									<td> 
										<input type='hidden' name='discountnya[]' id='discountnya' value='".$d->discountnya."'>
										<span>".$d->discount."</span>
									</td>
									<td>
										<input type='hidden' name='sub_total[]' id='valtotal2'>
					...
					<div class='alert alert-info TotalBayar'>
						...
						<h2 style="color: black">Total : <span id='TotalBayar'>Rp. <?php echo $master->grand_total ;?></span></h2>
						<input type="hidden" id='TotalBayarHidden' value="<?php echo $master->total_akhir_edit ;?>">
						<input type="hidden" id='Totaldiscounthidden' value="<?php echo $master->discount_total ;?>" >
						<input type="hidden" id='Totalitemdiscount' value="<?php echo $master->grand_total ;?>">
						<input type="hidden" id='TotalBayarHidden2' value="<?php echo $master->total_akhir_edit ;?>">
						...
						<div class='col-sm-5'>
							<div class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type='text' id='discount_all' class='form-control' value="<?php echo $master->discount_total ;?>">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-6 control-label">Total Setelah Discount</label>
									<div class="col-sm-6">
										<input type='text' id='TotalBayarHidden3' class='form-control' value="<?php echo $master->bayar2 ;?>" disabled>
									</div>
								</div>
								<div class="form-group">

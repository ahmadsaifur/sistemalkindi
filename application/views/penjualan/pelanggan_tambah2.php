<?php echo form_open('penjualan/tambah-pelanggan2', array('id' => 'FormTambahPelanggan')); ?>

<div class='form-group'>
	<label>NRMP</label>
	<input type='number' name='nrmp' class='form-control'>
</div>
<div class='form-group'>
	<label>Nama</label>
...
function TambahPelanggan()
{
	$.ajax({
		...
		dataType:'json',
		beforeSend:function(){
						$('#SimpanTambahPelanggan').html("Menyimpan Data, harap tunggu ...");
					},

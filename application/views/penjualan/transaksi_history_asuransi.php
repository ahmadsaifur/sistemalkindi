...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5 style="color:red"><i class='fa fa-shopping-cart fa-fw'></i> Penjualan <i class='fa fa-angle-right fa-fw'></i> History Asuransi</h5>
			<hr />

			<a href="<?php echo site_url('penjualan/history_asuransi');?>" type="button" class="btn btn-success">Transaksi OK</a>
			<a href="<?php echo site_url('penjualan/history_asuransi_acc'); ?>" type="button" class="btn btn-primary">Transaksi Pending</a>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('penjualan/history_json_asuransi'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

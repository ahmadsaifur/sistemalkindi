			...
			<div class='row'>
				<div class='col-sm-3'>
					<div class="panel panel-primary">
						<div class="panel-heading" style="background: orange"><i class='fa fa-file-text-o fa-fw'></i> Informasi Nota</div>
						<div class="panel-body" style="border: solid orange">
					...
					<div class="panel panel-primary" id='PelangganArea'>
						<div class="panel-heading" style="background: orange"><i class='fa fa-user'></i> Informasi Karyawan</div>
						<div class="panel-body" style="border: solid orange">
							<div class="form-group">
								<label>nama Karyawan</label>
								<!--<a href="<?php echo site_url('penjualan/tambah-pelanggan'); ?>" class='pull-right' id='TambahPelanggan'>Tambah Baru ?</a>-->
								<input id="id_pelanggan" class="form-control" type="text" name="id_pelanggan">
								<!--
				...
				<div class='col-sm-9'>
					<h5 class='judul-transaksi'>
						<i class='fa fa-shopping-cart fa-fw'></i> Penjualan <i class='fa fa-angle-right fa-fw'></i> Transaksi ASURANSI
						<a href="<?php echo site_url('penjualan/transaksi_asuransi'); ?>" class='pull-right'><i class='fa fa-refresh fa-fw'></i> Refresh Halaman</a>
					</h5>
...
function SimpanTransaksi()
{
	...
	FormData += "&id_herbalis="+$('#id_herbalis').val();
	FormData += "&" + $('#TabelTransaksi tbody input').serialize();
	FormData += "&catatan="+encodeURI($('#catatan').val());

	$.ajax({
		url: "<?php echo site_url('penjualan/transaksi_asuransi'); ?>",
		type: "POST",
		cache: false,
		data: FormData,
		dataType:'json',
		success: function(data){
			...
			{
				alert(data.pesan);
				window.location.href="<?php echo site_url('penjualan/transaksi_asuransi'); ?>";
			}
			else 
			{
				$('.modal-dialog').removeClass('modal-lg');

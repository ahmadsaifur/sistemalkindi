	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class='row'>
				...
				<div class='col-sm-9'>
				    <div class="panel panel-primary" style="border-color: #226000;" id='PelangganArea'>
						<div class="panel-heading" style="background: #226000 ;border-color: #226000;"><i class='fas fa-hamburge'></i> Pilih Produk</div>
						<div class="panel-body">
							<div class="form-group">
								<label>Pasien</label>
								<a href="<?php echo site_url('penjualan/tambah-pelanggan'); ?>" class='pull-right' id='TambahPelanggan'>Tambah Baru ?</a>

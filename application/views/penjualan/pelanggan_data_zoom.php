...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-shopping-cart fa-fw'></i> Penjualan <i class='fa fa-angle-right fa-fw'></i> Data Pasien ZOOM</h5>
			<hr />
			...
			<a href="<?php echo site_url('penjualan/pelanggan_zoom'); ?>" type="button" class="btn btn-success">Pasien ZOOM</a>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('penjualan/pelanggan-json-ZOOM'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

							...
							<div class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input id="id_herbalis_ori" readonly="readonly" class="form-control" type="text" name="nama_herbalis_ori">

										<button type="button" id="klik_herbalis" class="btn btn-primary btn-sm" data-toggle="modal" style="margin-top: 5px"><b> EDIT</b></button>
										<!--
										<select name='nama_herbalis_ori' id='id_herbalis_ori' class='form-control input-sm' style='cursor: pointer;'>
											...
											<option value='BM-BW'>BM-BW</option>
											<option value=''>----------</option>
											<option value='AY'>AY</option>
											<option value='AY-DN'>AY-DN</option>
											<option value='AY-MT'>AY-MT</option>
											<option value='AY-NS'>AY-NS</option>
											<option value='AY-NT'>AY-NT</option>
											<option value='AY-BT'>AY-BT</option>
											<option value='AY-BW'>AY-BW</option>
											<option value=''>----------</option>
											<option value='BW-NT'>BW-NT</option>
											<option value='BW-DN'>BW-DN</option>
											<option value='BW-MT'>BW-MT</option>
											<option value='BW-NS'>BW-NS</option>
											<option value='BW-DT'>BW-DT</option>
											<option value=''>----------</option>
											<option value='MT-NS'>MT-NS</option>
											<option value='MT-NT'>MT-NT</option>
											<option value='MT-DT'>MT-DT</option>
											<option value='MT-DN-WD'>MT-DN-WD</option>
											<option value=''>----------</option>
											<option value='NT-NS'>NT-NS</option>
											<option value='NS-DN'>NS-DN</option>
											<option value=''>----------</option>
											<option value='AY-MT-DT'>AY-MT-DT</option>
											<option value='AY-MT-NS'>AY-MT-NS</option>
											<option value='AY-MT-DN'>AY-MT-DN</option>
											<option value='DN-MT-DT'>DN-MT-DT</option>
											<option value='DT-DN-MT'>DT-DN-MT</option>
											<option value='DN-DT'>DN-DT
										</option>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#klik_herbalis").click(function() {

			$("#id_herbalis_ori").replaceWith("<select name='nama_herbalis_ori' id='id_herbalis_ori' class='form-control input-sm' style='cursor: pointer;'><option value=''>-- pilih Herbalis --</option><option value='Dr.Faruq'>Dr.Faruq</option><option value=''>----------</option><option value='BM-NS'>BM-NS</option><option value='BM-DN'>BM-DN</option><option value='BM-MT'>BM-MT</option><option value='BM-BW'>BM-BW</option><option value=''>----------</option><option value='AY'>AY</option><option value='AY-DN'>AY-DN</option><option value='AY-MT'>AY-MT</option><option value='AY-NS'>AY-NS</option><option value='AY-NT'>AY-NT</option><option value='AY-BT'>AY-BT</option><option value='AY-BW'>AY-BW</option><option value='AY-DT'>AY-DT</option><option value='AY-BM'>AY-BM</option><option value=''>----------</option><option value='BW-BM'>BW-BM</option><option value='BW-NT'>BW-NT</option><option value='BW-DN'>BW-DN</option><option value='BW-MT'>BW-MT</option><option value='BW-NS'>BW-NS</option><option value='BW-DT'>BW-DT</option><option value=''>----------</option><option value='MT-NS'>MT-NS</option><option value='MT-NT'>MT-NT</option><option value='MT-DT'>MT-DT</option><option value='MT-DN-WD'>MT-DN-WD</option><option value='MT-DN'>MT-DN</option><option value=''>----------</option><option value='NT-NS'>NT-NS</option><option value='NS-DN'>NS-DN</option><option value='NS'>NS</option><option value=''>----------</option><option value='AY-MT-DT'>AY-MT-DT</option><option value='AY-MT-NS'>AY-MT-NS</option><option value='AY-MT-DN'>AY-MT-DN</option><option value='DN-MT-DT'>DN-MT-DT</option><option value='DT-DN-MT'>DT-DN-MT</option><option value='DN-DT'>DN-DT</option> </select>");
			...
			if ($(this).val() !== '') {
				$.ajax({
					...
					success: function(json) {
						...
						$('#id_herbalis_ori').val(json.herbalis_online);
						$('#nrmp').val(json.nrmp);
	...
	function BarisBaru() {
		...
		Baris += "<td><input type='text' step='any' class='form-control' id='discount' name='discount[]'onkeypress='return isNumber(event)' disabled></td>";
		Baris += "<td>";
		// Baris += "<input type='hidden' step='any' name='discountnya[]' id='discountnya'>";
		Baris += "<input type='text' step='any' class='form-control' id='discountnya' name='discountnya[]'onkeypress='return isNumber(event)' disabled>";
		Baris += "<span></span>";
		Baris += "</td>";
		Baris += "<td>";
	...
	$(document).on('click', '#daftar-autocomplete li', function() {
		...
		$('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(9) input').removeAttr('disabled').val('');
	...
	$(document).on('keyup', '#discountnya', function() {
		var Indexnya = $(this).parent().parent().index();
		var Harga = $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(7) input').val();
		var discount = $(this).val();


		var SubTotal = parseFloat(discount) / parseInt(Harga) * 100;
		var SubTotalVal = parseInt(Harga) - parseFloat(discount);
		if (SubTotal > 0) {
			var SubTotal2 = SubTotal;
		...
		$('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(8) input').val(SubTotal);
	...
	function SimpanTransaksi() {
		...
		if ($('#TotalBayarHidden').val() > 0) {
			if ($('#UangCash').val() !== '') {
				...
				window.open("<?php echo site_url('penjualan/transaksi_cetak2/?'); ?>" + FormData, '_blank');
			} else {
				$('.modal-dialog').removeClass('modal-lg');
				$('.modal-dialog').addClass('modal-sm');
				$('#ModalHeader').html('Oops !');

...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-shopping-cart fa-fw'></i> Penjualan <i class='fa fa-angle-right fa-fw'></i> Data Pasien klinik</h5>
			<hr />

			<a href="<?php echo site_url('penjualan/pelanggan_online');?>" type="button" class="btn btn-primary">Pasien Online</a>
			<a href="<?php echo site_url('penjualan/pelanggan'); ?>" type="button" class="btn btn-success">Pasien Klinik</a>
...
{
	$tambahan .= nbs(2)."<a href='".site_url('penjualan/tambah-pelanggan')."' class='btn btn-success' id='TambahPelanggan'><i class='fa fa-plus fa-fw'></i> Tambah Pasien Baru Klinik</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('penjualan/pelanggan_json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

...
<div class="container-fluid">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-shopping-cart fa-fw'></i> Penjualan <i class='fa fa-angle-right fa-fw'></i> History Penjualan Online</h5>
			<hr />
            ...
            <?php if($level == 'admin') { ?>
			<a href="<?php echo site_url('penjualan/history_hapus_online'); ?>" type="button" class="btn btn-danger">Transaksi Hapus</a>
			<?php } ?>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('penjualan/history_json_online'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

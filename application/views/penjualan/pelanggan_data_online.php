...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-shopping-cart fa-fw'></i> Penjualan <i class='fa fa-angle-right fa-fw'></i> Data Pasien Online</h5>
			<hr />

			<a href="<?php echo site_url('penjualan/pelanggan_online');?>" type="button" class="btn btn-success">Pasien Online</a>
			<a href="<?php echo site_url('penjualan/pelanggan'); ?>" type="button" class="btn btn-primary">Pasien Klinik</a>
			<a href="<?php echo site_url('penjualan/pelanggan_zoom'); ?>" type="button" class="btn btn-primary">Pasien ZOOM</a>
...
{
	$tambahan .= nbs(2)."<a href='".site_url('penjualan/tambah_pelanggan2')."' class='btn btn-success' id='TambahPelanggan'><i class='fa fa-plus fa-fw'></i> Tambah Pasien Baru Online</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('penjualan/pelanggan-json-online'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
	...
	$(document).on('click', '#TambahPelanggan, #EditPelanggan', function(e){
		...
		{
			$('#ModalHeader').html('Tambah Pasien');
		}

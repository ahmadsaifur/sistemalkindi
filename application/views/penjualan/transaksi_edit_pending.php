			...
			<div class='row'>
						...
						<div class="panel-body">
							...
							<div class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type='text' name='tanggal' class='form-control input-sm' id='tanggal' readonly="true" value="<?php echo $master->tanggal; ?>">
									</div>
								</div>
								<div class="form-group">
				...
				<div class='col-sm-9'>
					...
					<div class='alert alert-info TotalBayar'>
						...
						<h2 style="color: black">Total : <span id='TotalBayar'>Rp. <?php echo $master->total_awal_edit ;?></span></h2>
						<input type="text" id='TotalBayarHidden' value="<?php echo $master->grand_total_edit ;?>">
						<input type="text" id='Totaldiscounthidden' value="<?php echo $master->discount_total_edit ;?>" >
						<input type="text" id='Totalitemdiscount' value="<?php echo $master->total_awal_edit;?>">
						<input type="text" id='TotalBayarHidden2' value="<?php echo $master->grand_total_edit;?>">
					</div>
...
function SimpanTransaksi()
{
	...
	$.ajax({
		url: "<?php echo site_url('penjualan/edit_transaksi'); ?>",
		type: "POST",
		cache: false,
		data: FormData,
		dataType:'json',

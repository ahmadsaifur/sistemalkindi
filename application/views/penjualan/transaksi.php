		...
		<div class="panel-body">
			...
			<div class='row'>
				<div class='col-sm-6'>
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<div class="form-horizontal" style="min-height: 215px;">
					...
					<div class="panel panel-primary" id='PelangganArea'>
						...
						<div class="panel-body">
							...
							<div class="form-horizontal">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">Herbalis</label>
									<div class="col-sm-8">
				...
				<div class='col-sm-12'>
					...
					<div class='alert alert-info TotalBayar' style="background: #99ff99; border-color: #99ff99;">
						<button  id='BarisBaru' class='btn btn-default pull-left'><i class='fa fa-plus fa-fw'></i> Baris Baru (F7)</button>
						<h2 style="color:black">Total : <span id='TotalBayar'>Rp. 0</span></h2>
...
$(document).on('keyup', '#discountnya', function() {
	...
	var discount = $(this).val();
				...
				if(SubTotalVal > 0){
				 ...
				 // $('#TabelTransaksi tbody tr:eq('+Indexnya+') td:nth-child(8) input').val(discount);

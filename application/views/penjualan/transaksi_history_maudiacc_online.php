...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-shopping-cart fa-fw'></i> Penjualan <i class='fa fa-angle-right fa-fw'></i> History Penjualan Online Acc</h5>
			<hr />

			<a href="<?php echo site_url('penjualan/history_online');?>" type="button" class="btn btn-primary">Transaksi OK</a>
			<a href="<?php echo site_url('penjualan/history_acc_apotek_online'); ?>" type="button" class="btn btn-primary">Transaksi Pending</a>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('penjualan/history-json_apotek_online'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

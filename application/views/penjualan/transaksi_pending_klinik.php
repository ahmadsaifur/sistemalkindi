...
<div class="container-fluid">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-shopping-cart fa-fw'></i> Penjualan <i class='fa fa-angle-right fa-fw'></i> Transaksi Penjualan Pending Klinik</h5>
			<hr />

			<a href="<?php echo site_url('penjualan/transaksi_pending');?>" type="button" class="btn btn-primary">Transaksi Pending Online</a>
			<a href="<?php echo site_url('penjualan/transaksi_pending_klinik'); ?>" type="button" class="btn btn-primary">Transaksi Pending Klinik</a>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('penjualan/history_json_pending_klinik'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
	...
	$(document).on('click', '#HapusTransaksi', function(e){
		...
		$('#ModalContent').html('Apakah anda yakin ingin <b>ACC</b> transaksi <b>'+$(this).parent().parent().find('td:nth-child(3)').text()+'</b> ?');

...
?>  
    ...
    <?php if($level == 'admin') { ?>
    <a href="<?php echo site_url('penjualan/pelanggan');?>" type="button" class="btn btn-success">Tambah Pasien</a>
    
    <a href="<?php echo site_url('penjualan/tambah-pelanggan');?>" type="button" class="btn btn-success" id='TambahPelanggan'>Tambah Pasien BARU Klinik</a>
    <?php } ?>
    
	<table class='table table-striped table-bordered' style="margin-top:10px">
	    <br>
	    <a style="color:black" id="ilang3" style="margin-bottom:10px">Data Jadwal Datang Kembali Pasien Klinik Tanggal <b style="color:red"> <b><?php echo $from; ?></b> !!!</b></a>
		<thead>
			<tr>
				<th>#</th>
				<th>NRMP</th>

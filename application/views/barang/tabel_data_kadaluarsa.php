...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Laporan <i class='fa fa-angle-right fa-fw'></i> List Obat Sudah Kadaluarsa</h5>
			<hr />
			
			<?php if($level == 'admin' OR $level == 'inventory') { ?>
			<a href="<?php echo site_url('barang/barang_kadaluarsa');?>" type="button" class="btn btn-primary">Tabel Data Akan Kadaluarsa</a>
			<?php } ?>
			
			<div class='table-responsive' style="margin-top:10px">
			    <a style="color:red" style="margin-bottom:10px"><b>Data Obat Yang Sudah Kadaluarsa !!!</b></a>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('barang/obat_sudah_kadaluarsa_json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

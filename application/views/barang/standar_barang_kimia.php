...
<div class="container-fluid">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Barang <i class='fa fa-angle-right fa-fw'></i>Standar Obat Kimia</h5>
			<hr />
            
            <a href="<?php echo site_url('barang/tambah_standar');?>" class="btn btn-primary" id='TambahBarang'>Tambah Barang</a>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('barang/barang_json_kimia_standar'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

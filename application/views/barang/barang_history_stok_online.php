...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Barang <i class='fa fa-angle-right fa-fw'></i> History Update Stok Obat Gudang</h5>
			<hr />
...
{   
	$tambahan .= nbs(2)."<a href='".site_url('barang/history_brg_online')."' class='btn btn-info'>History Obat Baru Online</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('barang/barang_json_history_stok_online'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Barang <i class='fa fa-angle-right fa-fw'></i> History Gudang Pusat</h5>
			<hr />
...
<script type="text/javascript" language="javascript">
	$(document).ready(function() {
		...
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax": {
				url: "<?php echo site_url('barang/barang_json_history_online'); ?>",
				type: "post",
				data: function() {
	...
	$(document).on('click', '#hapus_historis_Barang', function(e) {
		e.preventDefault();

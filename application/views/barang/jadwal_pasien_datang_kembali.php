	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class='table-responsive' style="margin-top:10px">
			    ...
			    <a style="color:black" style="margin-bottom:10px">Data Jadwal Datang Kembali Pasien Klinik Tanggal <b style="color:red"> <?php echo $tanggal ?> !!!</b></a>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('penjualan/list_pasien_datang_kembali_json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

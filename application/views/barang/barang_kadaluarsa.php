...
$tanggal = date('Y-m-d');
$tanggal2 = date('d M Y', strtotime('+3 months', strtotime($tanggal)));
?>

<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Laporan <i class='fa fa-angle-right fa-fw'></i> List Obat Akan Kadaluarsa</h5>
			<hr />
			<?php if($level == 'admin' OR $level == 'inventory') { ?>
			<a href="<?php echo site_url('barang/tabel_data_kadaluarsa');?>" type="button" class="btn btn-danger">Tabel Data Kadaluarsa</a>
			<?php } ?>
			
			<div class='table-responsive' style="margin-top:10px">
			    <a style="color:red" style="margin-bottom:10px"><b>Data Obat Yang Akan Kadaluarsa sampai tanggal <?php echo $tanggal2 ;?> !!!</b></a>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('barang/obat_kadaluarsa_json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

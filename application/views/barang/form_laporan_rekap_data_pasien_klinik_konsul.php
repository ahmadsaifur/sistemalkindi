...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Form Laporan Rekap Pasien Klinik KONSUL</h5>
			<hr />
...
$(document).ready(function(){
	    ...
	    var URL = "<?php echo site_url('penjualan/rekap_laporan_tahun_data_pasien_klinik_konsul'); ?>/" + TanggalDari;
			$('#result').load(URL);
	});
});

<?php echo form_open('barang/edit_rincian/'.$barang->id_barang, array('id' => 'FormEditBarang')); ?>
<?php
...
<div class="form-horizontal">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label">Isi Standar</label>
		<div class="col-sm-8">
			<?php 
			echo form_input(array(
				'name' => 'total_isi',
				'class' => 'form-control',
				'value' => $barang->total_isi
			));
			?>
		</div>
	</div>
	...
	<div class="form-group">
		<label class="col-sm-3 control-label">Info Tambahan</label>
		<div class="col-sm-8">
			<textarea name='info_tambahan' class='form-control' rows='3' style='resize:vertical;'><?php echo $barang->info_tambahan; ?></textarea>
		</div>
	</div>
</div>
<?php echo form_close(); ?>

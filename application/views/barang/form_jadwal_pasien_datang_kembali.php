	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<table id="my-grid" class="table table-striped table-bordered" >
			    ...
			    <?php if($level == 'admin') { ?>
                    <a href="<?php echo site_url('penjualan/pelanggan');?>" type="button" id="ilang" class="btn btn-success">Tambah Pasien</a>
                    
                    <a href="<?php echo site_url('penjualan/tambah-pelanggan');?>" type="button" class="btn btn-success" id='TambahPelanggan' style="margin-left:10px">Tambah Pasien BARU Klinik</a>
                <?php } ?>
                <br>
			    <p style="color:black" id="ilang3" style="margin-bottom:10px">Data Jadwal Datang Kembali Pasien Klinik Tanggal <b style="color:red"> <?php echo $tanggal ?> !!!</b></p>
					<thead>
						<tr>
							<th>#</th>
							<th>NRMP</th>
	        ...
	        <p style="color:red" id="ilang3" style="margin-bottom:10px">Catatan : 
	        <br>- Tabel Datang Kembali dari data pasien
	        <br>- Tabel Jadwal Konsul dari tanggal kembali transaksi pasien
	        </p>
		</div>
	</div>
</div>

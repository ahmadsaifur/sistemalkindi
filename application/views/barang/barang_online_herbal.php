...
<div class="container-fluid">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Barang <i class='fa fa-angle-right fa-fw'></i> Obat Gudang <b style='color:red'>HERBAL</b></h5>
			<hr />
			...
			<hr>
			<a href="<?php echo site_url('barang/update_stok_online'); ?>" class="btn btn-primary" id='UpdateStokBarang'>Update Gudang Herbal</a>
...
<script type="text/javascript" language="javascript">
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable({
			...
			"ajax": {
				url: "<?php echo site_url('barang/barang_json_online_herbal'); ?>",
				type: "post",
				error: function() {
					$(".my-grid-error").html("");
	...
	$(document).on('click', '#TambahBarang, #EditBarang, #UpdateStokBarang, #UpdateStokBarang_kimia', function(e) {
		e.preventDefault();

...
function BarisBaru()
{
	...
	var Baris = "<tr>";
	Baris += "<td>"+Nomor+"</td>";
	Baris += "<td><input type='text' name='kode[]' class='form-control input-sm'><span id='SamaKode'></span></td>";
	Baris += "<td><input type='text' name='nama[]' class='form-control input-sm normal'oninput='this.value = this.value.toUpperCase()'></td>";
	Baris += "<td>";
	...
	/*Baris += "<td><input type='text' name='satuan[]' class='form-control input-sm'></td>";*/
	Baris += "<td>";
	Baris += "<select name='satuan[]' class='form-control input-sm' style='width:100px;'>";
	Baris += "<option value=''></option>";
	...
	if($satuan->num_rows() > 0)
	{
		foreach($satuan->result() as $k) { ?>
			Baris += "<option value='<?php echo $k->satuan; ?>'><?php echo $k->satuan; ?></option>";
		<?php }
	}
	?>
	...
	Baris += "<td><textarea name='keterangan[]' class='form-control input-sm' readonly='readonly'>online</textarea></td>";

...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Obat Klinik</h5>
			<hr />
			...
			<br />
			<p style="color: red">Catatan : Laporan OBAT Pasien Klinik Gabungan Zoom Tanpa ATY</p>
			<div id='result'></div>
		</div>
	</div>
</div>
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_obatklinik'); ?>/" + TanggalDari + "/" + TanggalSampai;
			$('#result').load(URL);
		}
	});
});

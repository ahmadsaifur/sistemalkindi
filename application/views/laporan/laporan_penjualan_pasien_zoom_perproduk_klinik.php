			...
			foreach($penjualan->result() as $p)
			{
				echo "
					<tr>
						<td>".$no."</td>
						<td>".$p->tanggal."</td>
						<td><a href='".site_url('penjualan/detail-transaksi2_zoom_klinik/'.$p->id_penjualan_m)."' id='LihatDetailTransaksi'><i class='fa fa-file-text-o fa-fw'></i> ".$p->nomor_nota."</a></td>
						<td>".$p->grand_total."</td>

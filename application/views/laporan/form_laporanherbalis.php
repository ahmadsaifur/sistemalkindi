...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Herbalis</h5>
			<a href="<?php echo site_url('laporan/laporan_produk_perherbalis'); ?>" class='btn btn-info'>PER HERBALIS</a>
			<hr />
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_herbalis'); ?>/" + TanggalDari + "/" + TanggalSampai;
			$('#result').load(URL);
		}
	});
});

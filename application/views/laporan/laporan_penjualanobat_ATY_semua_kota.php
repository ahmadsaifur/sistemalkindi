<?php if($penjualan->num_rows() > 0) { ?>
	...
	<p>
		...
		$aty_kota 	= $Aty;
		?>
		<a href="<?php echo site_url('laporan/pdf_obat_online_ATY_semua_kota/'.$from.'/'.$to.'/'.$aty_kota); ?>" target='blank' class='btn btn-default'><img src="<?php echo config_item('img'); ?>pdf.png"> Export ke PDF</a>

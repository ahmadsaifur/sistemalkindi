...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Sales ATY SEMUA KOTA</h5>
			<a href="<?php echo site_url('laporan/laporan_sales_ATY'); ?>" class='btn btn-info'>PER KOTA</a>
			<hr />
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_sales_ATY_semua_kota'); ?>/" + TanggalDari + "/" + TanggalSampai;
			$('#result').load(URL);
		}
	});
});

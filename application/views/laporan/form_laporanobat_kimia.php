...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Obat Kimia</h5>
			<hr />
			...
			<br />
			<p style="color: red">Catatan : Laporan OBAT Kimia Gabungan Klinik dan Online dan zoom dan aty</p>
			<div id='result'></div>
		</div>
	</div>
</div>
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_obat_kimia'); ?>/" + TanggalDari + "/" + TanggalSampai;
			$('#result').load(URL);
		}
	});
});

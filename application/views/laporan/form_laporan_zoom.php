...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Pasien Zoom Online</h5>
			<hr />
			<a href="<?php echo site_url('laporan/laporan_pasien_zoom_perproduk'); ?>" class='btn btn-info'>LAPORAN PASIEN ZOOM PER PRODUK</a>
			<hr />
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_zoom'); ?>/" + TanggalDari + "/" + TanggalSampai;
			$('#result').load(URL);
		}
	});
});

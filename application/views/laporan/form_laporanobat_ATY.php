...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Obat Online ATY </h5>
			
			<a href="<?php echo site_url('laporan/laporan_obat_ATY'); ?>" class='btn btn-info'>SEMUA KOTA</a>
			<hr />
			...
			<br />
			<p style="color: red">Catatan : Laporan Obat Online ATY Saja </p>
			<div id='result'></div>
		</div>
	</div>
</div>
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_obat_ATY'); ?>/" + TanggalDari + "/" + TanggalSampai + "/" + kota_ATY;
			$('#result').load(URL);
		}
	});
});

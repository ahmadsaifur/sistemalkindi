<?php if($penjualan->num_rows() > 0) { ?>
	...
	<p>
		...
		?>
		<a href="<?php echo site_url('laporan/pdf_perpasien_klinik/'.$from.'/'.$to); ?>" target='blank' class='btn btn-default'><img src="<?php echo config_item('img'); ?>pdf.png"> Export ke PDF</a>

...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Pasien Online ATY</h5>
			<a href="<?php echo site_url('laporan/laporan_pasien_ATY_semua_kota'); ?>" class='btn btn-info'>SEMUA KOTA</a>
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_pasien_ATY'); ?>/" + TanggalDari + "/" + TanggalSampai + "/" + kota_ATY;
			$('#result').load(URL);
		}
	});
});

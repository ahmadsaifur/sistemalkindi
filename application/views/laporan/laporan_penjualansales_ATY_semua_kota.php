<?php if($penjualan->num_rows() > 0) { ?>
	...
	<p>
		...
		?>
		<a href="<?php echo site_url('laporan/pdf_persales_ATY_semua_kota/'.$from.'/'.$to); ?>" target='blank' class='btn btn-default'><img src="<?php echo config_item('img'); ?>pdf.png"> Export ke PDF</a>

<?php if($penjualan->num_rows() > 0) { ?>
	...
	<p>
		...
		$saless 	= $sales;
		?>
		<a href="<?php echo site_url('laporan/pdf_persales/'.$from.'/'.$to.'/'.$saless); ?>" target='blank' class='btn btn-default'><img src="<?php echo config_item('img'); ?>pdf.png"> Export ke PDF</a>

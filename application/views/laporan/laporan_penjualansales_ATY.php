<?php if($penjualan->num_rows() > 0) { ?>
	...
	<p>
		...
		$Aty		= $aty;
		?>
		<a href="<?php echo site_url('laporan/pdf_persales_ATY/'.$from.'/'.$to.'/'.$Aty); ?>" target='blank' class='btn btn-default'><img src="<?php echo config_item('img'); ?>pdf.png"> Export ke PDF</a>

...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Sales Per Produk</h5>
			<hr />
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_sales_perproduk'); ?>/" + TanggalDari + "/" + TanggalSampai + "/" + sales;
			$('#result').load(URL);
		}
	});
});

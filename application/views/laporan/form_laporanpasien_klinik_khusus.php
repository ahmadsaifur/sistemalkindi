...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Pasien Klinik <b>KHUSUS</b></h5>
			<hr />
			...
			<?php echo form_close(); ?>
			<br />
			<p style="color: red">Catatan : Laporan Pasien Klinik <b>KHUSUS</b> Gabungan Zoom Tanpa ATY</p>
			<br />
			<div id='result'></div>
		</div>
	</div>
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_pasienklinik_khusus'); ?>/" + TanggalDari + "/" + TanggalSampai;
			$('#result').load(URL);
		}
	});
});

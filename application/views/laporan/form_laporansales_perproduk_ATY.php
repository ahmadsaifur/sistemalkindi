...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Sales Per Produk ATY</h5>
			<hr />
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<div class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-5 control-label">Pilih Sales</label>
							<div class="col-sm-7">
								<select name='sales' id='saless' class='form-control' style='cursor: pointer;'>
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		var sales = $('#saless').val();
		var kota_ATY = $('#aty_kota').val();
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_sales_perproduk_ATY'); ?>/" + TanggalDari + "/" + TanggalSampai + "/" + sales + "/" + kota_ATY;
			$('#result').load(URL);
		}
	});
});

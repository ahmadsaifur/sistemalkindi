...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Obat Pasien Zoom Klinik</h5>
			<hr />
			...
			<br />
			<p style="color: red">Catatan : Laporan Obat Klinik Zoom Aja</p>
			<br />
			<div id='result'></div>
		</div>
	</div>
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_obat_pasien_zoom_klinik'); ?>/" + TanggalDari + "/" + TanggalSampai /*+ "/" + herbalis*/;
			$('#result').load(URL);
		}
	});
});

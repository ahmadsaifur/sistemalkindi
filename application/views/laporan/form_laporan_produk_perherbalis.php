...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Penjualan Herbalis Per Produk</h5>
			<a href="<?php echo site_url('laporan/laporan_herbalis'); ?>" class='btn btn-info'>HERBALIS</a>
			<hr />
				...
				<div class="col-sm-4">
					<div class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<select name='aty' id='obt_herbalis' class='form-control' style='cursor: pointer;'>
									<option value='a'>-- PILIH HERBALIS --</option>
...
$(document).ready(function(){
	$('#FormLaporan').submit(function(e){
		...
		var kde_herbalis = $('#obt_herbalis').val();
		...
		{
			var URL = "<?php echo site_url('laporan/penjualan_herbalis_perproduk'); ?>/" + TanggalDari + "/" + TanggalSampai + "/" + kde_herbalis;
			$('#result').load(URL);
		}
	});
});
